...
android {
    namespace = "io.github.afalabarce.jetpackcompose.ads.applovin"
...
publishing {
    publications {
        ...
        withType<MavenPublication>{
            ...
            pom {
                packaging = "aar"
                name.set(SonatypePublishingAppLovin.artifact)
                description.set(SonatypePublishingAppLovin.libraryDescription)
